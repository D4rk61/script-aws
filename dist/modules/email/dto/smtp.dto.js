...
const smtp_auth_dto_1 = require("./smtp-auth.dto");
class SmtpConfigDTO {
}
...
__decorate([
    ...
    (0, class_transformer_1.Type)(() => smtp_auth_dto_1.SmtpAuthDTO),
    __metadata("design:type", smtp_auth_dto_1.SmtpAuthDTO)
], SmtpConfigDTO.prototype, "auth", void 0);
